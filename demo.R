...
# fetch the data interval that we want to analyze from configuration
...
#print(getCurrencyPairList(pairsWithDataInTimeWindow)[[7]])
#write(getCurrencyPairList(pairsWithDataInTimeWindow)[[7]], file="timewindow")
