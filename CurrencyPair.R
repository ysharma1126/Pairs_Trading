...
setMethod(f="initializeCurrencyPair",signature=c("CurrencyPair","character","list","list","POSIXlt","POSIXlt"),definition=function(theObject,id,dataFrameBid,dataFrameAsk,beginTimeStamp,endTimeStamp)
{
    ...
    # - Volume: Volume indicator. We only use volume information to detect missing data entries.Those entries contain 0 value volumes.
...
# The class Overwrites the initializeCurrencyPair function in order to recalculate inverted timeseries and corresponding transaction costs
#
